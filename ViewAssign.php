  ...
  <div id="container">
    <div id="content">
      ...
      <table style="width:60%;color:#990066; font-size:16px; font-weight:bold; font-family:'Times New Roman', Times, serif">
        ...
        <tr>
          <td colspan="2" align="center" style="font-size:18px; font-weight:bold">Student ID  &nbsp;&nbsp;
		  <?php 
		  		session_start();
				$sid=$_SESSION['uname'];
		  ?>
              <input type="text" name="name" value="<?php echo $sid?>"/></td>
        </tr>
	                <tr>
    ...
    <td style="background-color:#00FFFF;color:#000033">Internal</td>
    <td style="background-color:#00FFFF;color:#000033">External</td>
...
include("config.php");
	...
	//$name=$_POST['name'];
	//$dept=$_POST['dept'];
	$result =mysql_query("Select * from Project where StudentID = '$sid'");
	$id = $_POST['menu1'];
