  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
		...
		<li class="last"><a href="StudentLogin.php">Student</a></li>
      </ul>
    </div>
    <div id="search">
...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
      <h1 style="color:#46286F; font-size:36px;">Student Login Page</h1>
	  <form id="form1" name="form1" method="post" action="Slogindata.php">
	  <center>
      <table style="width:60%;color:#990066; font-size:16px; font-weight:bold; font-family:'Times New Roman', Times, serif">
        ...
        <tr>
          <td>Student ID </td>
          <td><input type="text" name="uname" style="background:#FFFFFF;color:#000066; font-size:16px;" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>Password</td>
          <td><input type="password" name="pwd" style="background:#FFFFFF;color:#000066; font-size:16px;" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
